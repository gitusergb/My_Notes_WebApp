...
const [password,setPassword]=useState("");
      ...
      const handleSubmit = async() => {
       ...
       fetch("https://notes-server-o8j5.onrender.com/users/login",{
        ...
        console.log(data)
         // Assuming login is successful, call the login function from the context
         login();
        //we have stored the token in local storage to get it from there for futher operations
